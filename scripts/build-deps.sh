...
BATCHES=(
    ...
    "openssl gmp zlib libiconv xz ogg lame opus freetype expat fribidi speex soxr twolame shine opencore-amr snappy xml2 rubberband vmaf jxl webp openjpeg zimg vidstab xvid x264 x265 openh264 kvazaar vvenc davs2 xavs2 uavs3d dav1d vpx aom svtav1 sdl2 librist"
